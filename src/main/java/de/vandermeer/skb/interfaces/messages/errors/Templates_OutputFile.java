...
public enum Templates_OutputFile implements IsErrorTemplate {
	 ...
	 * Arguments: file type, filename, input file type, filename.
	 */
	FN_SAMEAS_INFN(
			-316,
	 ...
	 * Arguments: file type, filename, overwrite option.
	 */
...
//	),
	 ...
	 * Arguments: file type, filename, override option.
	 */
	FILE_NOOVERRIDE(
			-328,
