 ...
 * 		<li>{@link de.vandermeer.skb.interfaces.messages.FormattingTupleWrapper} - a wrapper to create SLF4J formatting tuples and convert them into strings when needed.
