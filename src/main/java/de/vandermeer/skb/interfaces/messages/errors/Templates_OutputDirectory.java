...
public enum Templates_OutputDirectory implements IsErrorTemplate {
	 ...
	 * Arguments: directory type, directory name.
	 */
	DN_HAS_EXTENSION(
			-373,
	 ...
	 * Arguments: directory type, input directory type, directory name.
	 */
	DN_SAMEAS_INDN(
			-374,
	 ...
	 * Arguments: directory type, directory name, option activating overwrite.
	 */
	 ...
	 * Arguments: directory type, directory name, override option.
	 */
	 ...
	 * Arguments: directory type, directory name, pattern for files, override option.
	 */
	 ...
	 * Arguments: directory type, directory name, exception message.
	 */
	 ...
	 * Arguments: directory type, parent name.
	 */
	PARENT_CANT_WRITE(
			-391,
