 ...
 * @since      v0.0.1
 */
public interface FormattingTupleWrapper extends DoesRender {

	/**
	 * Creates a new wrapper.
	 * @param tuple a formatting tuple, must not be null
	 * @return new wrapper with given message
	 * @throws NullPointerException if `tuple` was null
	 */
	static FormattingTupleWrapper create(final FormattingTuple tuple){
