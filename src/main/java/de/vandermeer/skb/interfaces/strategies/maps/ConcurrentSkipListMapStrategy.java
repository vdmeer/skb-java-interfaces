 ...
 * @since      v0.0.1
 */
public interface ConcurrentSkipListMapStrategy<K extends Comparable<K>, V> extends IsSortedMapStrategy<K, V>, IsNavigableMapStrategy<K, V>, IsConcurrentMapStrategy<K, V> {
