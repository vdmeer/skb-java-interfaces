...
/**
 * Standard Property Option errors.
 * 
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v0.0.2 build 170502 (02-May-17) for Java 1.8
 * @since      v0.0.3
 */
public enum Templates_PropertiesOptions implements IsErrorTemplate {

	/**
	 * A property parser tried to set a value for a required property, but value was blank.
	 * Arguments: application name, property key.
	 */
	VALUE_REQUIRED_BLANK(
			-190,
			"{}: value for mandatory property <{}> was blank",
			"A property parser tried to set a value for a required property, but value was blank."
	),

	/**
	 * An integer option tried to convert a string to an integer and caugh an exception.
	 ...
	 */
	Templates_PropertiesOptions(final int code, final String message, final String description){
	...
	public IsErrorCategory getCategory() {
		return StandardErrorCategories.PROPERTIES_OPTIONS;
	}
