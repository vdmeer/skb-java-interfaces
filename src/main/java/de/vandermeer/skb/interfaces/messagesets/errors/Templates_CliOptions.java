...
/**
 * Standard CLI Option errors.
 * 
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v0.0.2 build 170502 (02-May-17) for Java 1.8
 * @since      v0.0.3
 */
public enum Templates_CliOptions implements IsErrorTemplate {

	/**
	 * A CLI parser tried to set a mandatory argument for an option but its value was null.
	 * Arguments: application name, argument name, long or short options.
	 */
	MANDATORY_ARG_NULL(
			-150,
			"{}: mandatory argument <{}> for option <{}> was null",
			"A CLI parser tried to set a mandatory argument for an option but its value was null."
	),
	 ...
	 */
	Templates_CliOptions(final int code, final String message, final String description){
	...
	public IsErrorCategory getCategory() {
		return StandardErrorCategories.CLI_OPTIONS;
	}
