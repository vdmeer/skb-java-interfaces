...
public interface IsErrorTemplate extends HasDescription, CategoryIs {
	 ...
	 */
	default IsError getError(final String appName){
		return this.getError(appName, new Object[0]);
	}
	 ...
	 */
	default IsError getError(final String appName, final Object ... args){
		Validate.notBlank(appName);
		Validate.noNullElements(args);
		Validate.validState(args.length==this.expectedArguments()-1);
