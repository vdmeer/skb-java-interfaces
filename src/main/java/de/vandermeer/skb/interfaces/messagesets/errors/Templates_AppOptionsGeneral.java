...
/**
 * Standard Application Options General errors.
 * 
 * @author     Sven van der Meer &lt;vdmeer.sven@mykolab.com&gt;
 * @version    v0.0.2 build 170502 (02-May-17) for Java 1.8
 * @since      v0.0.3
 */
public enum Templates_AppOptionsGeneral implements IsErrorTemplate {

//	/**
//	 * A home directory for the application does not exist.
//	 * Arguments: application name.
//	 */
//	DIR_NOT_SET(
//			-120,
//			"{}: application directory not set",
//			"A required home directory for the application is not set."
//	),
//
//	/**
//	 * A home directory for the application does not exist.
...
//	),
	 ...
	 */
	Templates_AppOptionsGeneral(final int code, final String message, final String description){
	...
	public IsErrorCategory getCategory() {
		return StandardErrorCategories.APP_OPTIONS_GENERAL;
	}
