 ...
 * @since      v0.0.3
 */
public interface Text2Latex extends CombinedTranslator {

	/**
	 * Returns a new combined translator for text to LaTeX.
	...
	default String text2tmp(String input) {
		return de.vandermeer.skb.interfaces.translators.htmlelement.Text2Latex.create().text2tmp(input);
	}

	@Override
	default String tmp2target(String input) {
		return de.vandermeer.skb.interfaces.translators.htmlelement.Text2Latex.create().tmp2target(input);
	}
	...
	default String translateCharacters(String input) {
		return de.vandermeer.skb.interfaces.translators.character.Text2Latex.create().translateCharacters(input);
	}

	@Override
	default String translateHtmlElements(String input) {
		return de.vandermeer.skb.interfaces.translators.htmlelement.Text2Latex.create().translateHtmlElements(input);
	}
