 ...
 * @since      v0.0.3
 */
public interface Text2Html_HEntity extends HtmlElementTranslator {

	/**
	 * Creates a new text to HTML HTML-element translator.
	 * @return new translator
	 */
	static Text2Html_HEntity create(){
		return new Text2Html_HEntity() {
		};
	}
	...
	default String tmp2target(String input){
		return StringUtils.replaceEach(input, REPLACEMENT_LIST_HE, SEARCH_LIST_HE);
	}

	@Override
	default String translateHtmlElements(String input){
		return StringUtils.replaceEach(input, SEARCH_LIST_HE, SEARCH_LIST_HE);
	}
}
