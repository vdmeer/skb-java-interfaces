...
public interface Text2Html extends CombinedTranslator {
	...
	default String text2tmp(String input) {
		return de.vandermeer.skb.interfaces.translators.htmlelement.Text2Html.create().text2tmp(input);
	}

	@Override
	default String tmp2target(String input) {
		return de.vandermeer.skb.interfaces.translators.htmlelement.Text2Html.create().tmp2target(input);
	}
	...
	default String translateCharacters(String input) {
		return de.vandermeer.skb.interfaces.translators.character.Text2Html.create().translateCharacters(input);
	}

	@Override
	default String translateHtmlElements(String input) {
		return de.vandermeer.skb.interfaces.translators.htmlelement.Text2Html.create().translateHtmlElements(input);
	}
