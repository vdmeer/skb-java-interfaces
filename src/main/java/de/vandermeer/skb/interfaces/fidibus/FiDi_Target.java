 ...
 * @since      v0.0.3
 */
public interface FiDi_Target extends FiDi_Role {

	/**
	 * Returns the actual target.
	 * For instance, if the target is a path in the file system this method should return the path.
	 * @return object representation of the target
	 */
	Object getTarget();

	/**
	 * Validates the target against various options.
	...
	/**
	 * Flag for a valid target, has been validated without errors.
