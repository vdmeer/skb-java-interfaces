...
public class Test_Templates_InputDirectory {
	...
	public void test_SomeErrors(){
		...
		msg = Templates_InputDirectory.DN_NULL.getError("output").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);

		msg = Templates_InputDirectory.DN_HAS_EXTENSION.getError("output", "me.zip").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);

		msg = Templates_InputDirectory.DIR_IS_HIDDEN.getError("target", "folder").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);
	}
}
