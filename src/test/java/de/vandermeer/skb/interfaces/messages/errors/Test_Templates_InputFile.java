...
public class Test_Templates_InputFile {
	...
	public void test_SomeErrors(){
		...
		msg = Templates_InputFile.FN_NULL.getError("input").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);

		msg = Templates_InputFile.FN_HAS_EXTENSION.getError("input", "me.zip").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);

		msg = Templates_InputFile.FN_WRONG_EXTENSION.getError("input", "me.zip", "one of pdf, png, or svg").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);
	}
}
