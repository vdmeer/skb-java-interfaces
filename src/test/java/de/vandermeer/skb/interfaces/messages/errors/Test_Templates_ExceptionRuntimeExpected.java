...
import de.vandermeer.skb.interfaces.messages.errors.Templates_ExceptionRuntimeExpected;
...
public class Test_Templates_ExceptionRuntimeExpected {
	...
	public void test_SomeErrors(){
		...
		msg = Templates_ExceptionRuntimeExpected.E_NULL_POINTER.getError("class", "action", "msg").render();
