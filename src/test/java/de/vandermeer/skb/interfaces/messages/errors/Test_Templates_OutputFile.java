...
public class Test_Templates_OutputFile {
	...
	public void test_SomeErrors(){
		...
		msg = Templates_OutputFile.FN_NULL.getError("output").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);

		msg = Templates_OutputFile.FN_HAS_EXTENSION.getError("output", "me.zip").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);

		msg = Templates_OutputFile.FN_WRONG_EXTENSION.getError("output", "me.zip", "one of pdf, png, or svg").render();
		assertTrue(StringUtils.isNotBlank(msg));
		System.out.println(msg);
	}
}
