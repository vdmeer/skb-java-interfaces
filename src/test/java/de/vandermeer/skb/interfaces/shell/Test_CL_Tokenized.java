...
//	}
	...
	public void test_singleHead(){
		CommandLineTokens clk = CommandLineTokens.create("cmd");
	...
	public void test_doubleHead(){
		CommandLineTokens clk = CommandLineTokens.create("cmd1 cmd2");
	...
	public void test_trippleHead(){
		CommandLineTokens clk = CommandLineTokens.create("cmd1 cmd2 cmd3");
	...
	public void test_singleTail(){
		CommandLineTokens clk = CommandLineTokens.create("cmd:val");
	...
	public void test_doubleTail(){
		CommandLineTokens clk = CommandLineTokens.create("cmd1:val1 cmd2:val2");
	...
	public void test_trippleTail(){
		CommandLineTokens clk = CommandLineTokens.create("cmd1:val1 cmd2:val2 cmd3:val3");
