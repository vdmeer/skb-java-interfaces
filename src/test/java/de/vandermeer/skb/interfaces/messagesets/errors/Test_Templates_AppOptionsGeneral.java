...
public class Test_Templates_AppOptionsGeneral {
	...
	public void test_AppnameArg(){
		for(Templates_AppOptionsGeneral error : Templates_AppOptionsGeneral.values()){
...
//		msg = Templates_AppOptionsGeneral.DIR_NOT_SET.getError("app").getErrorMessageString();
